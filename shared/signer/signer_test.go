...
func TestSigner_SignPublisherPrice_Evm(t *testing.T) {
	...
	signedNegativePriceUpdate, assetId, err := signer.SignPublisherPrice(
		1710191092123456789,
		"BTCUSDMARK",
		"-72147681412670819000000",
	)
...
func TestSigner_SignAuth_Evm(t *testing.T) {
	...
	assert.Equal(
		t,
		"0x2bde80c32c372aaf187b793d188ac13f7f1c92ec0121dc99b57ebfbfda74cecf06d37333f3b56864090d77b7fe3efb815ced8270bfb47cbc3f806d957063bf3a1b",
		signatureStr,
	)
}

func TestSigner_SignAuth_Stark(t *testing.T) {
	signer, err := NewStarkAuthSigner(
		"0x66253bdeb3c1a235cf4376611e3a14474e2c00fd2fb225f9a388faae7fb095a",
		"0x418d3fd8219a2cf32a00d458f61802d17f01c5bcde5a4f82008ee4a7c8e9a06",
		zerolog.Logger{},
	)
	...
	assert.Equal(
		t,
		"0x06d317d0c403d4bb822db27843f7cca56f5922863ced48b380e6c4494c7d23a70296da7fd09ed7e436a91d5667fa7d5f0f969d739231c2ba1fa00aa364b2dfe2",
		signatureStr,
	)
}
