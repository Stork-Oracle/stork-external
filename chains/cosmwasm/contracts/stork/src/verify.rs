...
fn get_stork_message_hash(
    ...
    data.extend_from_slice(&[sign_extension_byte; 16]); // Left pad with 16 zero bytes
...
mod tests {
    ...
    fn test_verify_stork_evm_signature_negative_value() {
        ...
        let stork_public_key = hex_to_bytes("0x3db9E960ECfCcb11969509FAB000c0c96DC51830")[..20]
            .try_into()
            .unwrap();
        ...
        let publisher_merkle_root = hex_to_bytes("5ea4136e8064520a3311961f3f7030dfbc0b96652f46a473e79f2a019b3cd878")
            [..32]
            .try_into()
            .unwrap();
        let value_compute_alg_hash = hex_to_bytes("9be7e9f9ed459417d96112a7467bd0b27575a2c7847195c68f805b70ce1795ba")
            [..32]
            .try_into()
            .unwrap();
