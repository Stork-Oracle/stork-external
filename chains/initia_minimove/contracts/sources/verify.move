module stork::verify {
    ...
    use initia_std::secp256k1::{Self, ECDSASignature, ECDSARawPublicKey};
    use initia_std::aptos_hash::keccak256;
    use std::vector;
    use std::option;
    ...
    fun get_stork_message_bytes(
        ...
        data.append(vector[sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte, sign_extension_byte]);
...
// === Tests ===
    ...
    #[test]
    fun test_verify_evm_signature_negative_value() {
