...
At the time of writing there is no way to generate Go bindings for Sui automatically. Manually built contract bindings/utilities can be found [here](../apps/lib/chain_pusher/contract_bindings/sui/stork_sui_contract.go).
...
At the time of writing there is no way to generate Go bindings for CosmWasm automatically. Manually built contract bindings/utilities can be found [here](../apps/lib/chain_pusher/contract_bindings/cosmwasm/stork_cosmwasm_contract.go).
...
The Fuel pusher relies on [rust bindings](../apps/lib/chain_pusher/contract_bindings/fuel/fuel_ffi/src/lib.rs) called from go via cgo [here](../apps/lib/chain_pusher/contract_bindings/fuel/stork_fuel_contract.go). The rust bindings are reliant on [stork-abi.json](../apps/lib/chain_pusher/contract_bindings/fuel/fuel_ffi/stork-abi.json). Ensure this is the latest version of the abi. The abi is generated by running `npx fuels build` in the `contracts/fuel/cli` directory, and can be found in [/contracts/fuel/out/release/stork-abi.json](../contracts/fuel/contracts/stork/out/release/stork-abi.json) once built.
