...
import (
	...
	"github.com/Stork-Oracle/stork-external/apps/lib/data_provider/sources/monadtokenprice"
	"github.com/Stork-Oracle/stork-external/apps/lib/data_provider/utils"
	"github.com/stretchr/testify/assert"
)

func TestValidMonadTokenPriceConfig(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, monadtokenprice.MonadTokenPriceDataSourceId, dataSourceId)

	sourceSpecificConfig, err := monadtokenprice.GetSourceSpecificConfig(sourceConfig)
	assert.NoError(t, err)
