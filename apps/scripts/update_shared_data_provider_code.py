...
IMPORT_SOURCES_FILE = './apps/lib/data_provider/config/import_sources.go'
SOURCES_DIR = "./apps/lib/data_provider/sources"
CONFIG_SCHEMA_FILE = './apps/lib/data_provider/config/resources/data_provider_config.schema.json'
CONFIG_SCHEMA_TEMPLATE_FILE = './apps/lib/data_provider/config/resources/data_provider_config.schema.json.template'
