...
func TestLoadConfig(t *testing.T) {
	...
	assert.Equal(t, signer.EvmPrivateKey("0x8b558d5fc31eb64bb51d44b4b28658180e96764d5d5ac68e6d124f86f576d9de"), secrets.EvmPrivateKey)
	assert.Equal(t, signer.EvmPublisherKey("0x99e295e85cb07c16b7bb62a44df532a7f2620237"), config.EvmPublicKey)
	assert.Equal(t, signer.StarkPrivateKey("0x66253bdeb3c1a235cf4376611e3a14474e2c00fd2fb225f9a388faae7fb095a"), secrets.StarkPrivateKey)
...
func TestLoadKeys(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, signer.EvmPrivateKey("0x8b558d5fc31eb64bb51d44b4b28658180e96764d5d5ac68e6d124f86f576d9de"), keys.EvmPrivateKey)
	assert.Equal(t, signer.EvmPublisherKey("0x99e295e85cb07c16b7bb62a44df532a7f2620237"), keys.EvmPublicKey)
	assert.Equal(t, signer.StarkPrivateKey("0x66253bdeb3c1a235cf4376611e3a14474e2c00fd2fb225f9a388faae7fb095a"), keys.StarkPrivateKey)
	assert.Equal(t, signer.StarkPublisherKey("0x418d3fd8219a2cf32a00d458f61802d17f01c5bcde5a4f82008ee4a7c8e9a06"), keys.StarkPublicKey)
